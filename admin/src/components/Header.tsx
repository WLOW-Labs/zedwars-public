...
const Header = () => {
  ...
  return (
    <>
      <Box bg='white.800' color='gray.400'>
        <Flex maxW='6xl' mx='auto' py={6} px={4} align='center' justify='space-between'>
          <Flex align='center'>
            <Box position={'absolute'} left={'0'} bottom='0'>
              <IconButton onClick={onOpen} borderRadius='0' aria-label='Change Characters' backgroundColor='#577277' borderColor='#A8B5B2' borderWidth={'3px'} _hover={{ borderColor: '#394A50' }} icon={<Icon viewBox="0 0 24 24" stroke='white' fill='white'>
      ...
      <Drawer placement={'top'} onClose={onClose} isOpen={isOpen}>
        <DrawerOverlay />
        <DrawerContent>
          <DrawerHeader borderBottomWidth={'1px'}>Debug Panel</DrawerHeader>
          <DrawerBody>
